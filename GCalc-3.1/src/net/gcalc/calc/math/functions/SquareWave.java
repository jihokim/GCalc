...
public class SquareWave extends EngineeringOperation {
	public SquareWave(ParseTree pt) {
		super(pt);
	...
	public double evaluate(SymbolTable st, ValueTable vt) {
		double t = ((Function) getArg(0)).evaluate(st, vt);
		double d = ((Function) getArg(1)).evaluate(st, vt);
		double T = ((Function) getArg(2)).evaluate(st, vt);
