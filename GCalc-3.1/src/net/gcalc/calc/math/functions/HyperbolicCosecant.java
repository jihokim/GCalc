...
public class HyperbolicCosecant extends HyperbolicTrigOperation
{
    public HyperbolicCosecant(ParseTree pt)
    {
	super(pt);
    }
	...
	return FunctionFactory.getFunction(MULT_TOKEN,
			   ...
			   FunctionFactory.getFunction(MULT_TOKEN,
				       FunctionFactory.getFunction(COTH_TOKEN, var),
				       FunctionFactory.getFunction(CSCH_TOKEN, var)
				       )
			   );
    }
