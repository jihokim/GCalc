...
public class HyperbolicSecant extends HyperbolicTrigOperation
{
    public HyperbolicSecant(ParseTree pt)
    {
	super(pt);
    }
	...
	return FunctionFactory.getFunction(MULT_TOKEN,
			   ...
			   FunctionFactory.getFunction(MULT_TOKEN,
				       FunctionFactory.getFunction(SECH_TOKEN, var),
				       FunctionFactory.getFunction(TANH_TOKEN, var)
				       )
			   );
    }
