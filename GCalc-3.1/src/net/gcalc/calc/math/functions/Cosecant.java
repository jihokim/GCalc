...
public class Cosecant extends UnaryOperation
{
    public Cosecant(ParseTree pt)
    {
	super(pt);
    }
    ...
    {
	return 1.0/Math.sin(evaluateArgument(st, vt));
    }
	...
	return FunctionFactory.getFunction(MULT_TOKEN,
			   FunctionFactory.getFunction(MULT_TOKEN,
				       FunctionFactory.getFunction(COT_TOKEN, var),
				       FunctionFactory.getFunction(CSC_TOKEN, var)),	   
