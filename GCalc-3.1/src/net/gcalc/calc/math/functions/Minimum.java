...
public class Minimum extends VariableArityFunction
{
    ...
    public Function derivative(Vector vars)
    {
        ...
        Function f = minimum(0, (getNumberOfArgs()-1)/2);
        Function g = minimum((getNumberOfArgs()-1)/2+1, getNumberOfArgs()-1);
    ...
    private Function minimum(int a, int b)
    {
        Vector v = new Vector();
        for (int i=a; i<=b; i++)
            v.add(this.getArg(i));
            
        return FunctionFactory.getFunction(MIN_TOKEN, v);
    }
