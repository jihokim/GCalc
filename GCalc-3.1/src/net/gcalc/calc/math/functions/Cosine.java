...
public class Cosine extends UnaryOperation{
    ...
    {
	return Math.cos(evaluateArgument(st, vt));
    }

    public Function derivative(Vector vars)
    {
	return FunctionFactory.getFunction(NEGATE_TOKEN,
			   FunctionFactory.getFunction(MULT_TOKEN, 
				       FunctionFactory.getFunction(SIN_TOKEN, var),
				       var.derivative(vars)));
