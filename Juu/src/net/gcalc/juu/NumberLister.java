...
public abstract class NumberLister extends Lister<GNumber>
{
	protected NumberLister(Node node) {
		super(node);
	}
	
	protected GNumber process(Object data) {
		if (data instanceof GNumber) {
			return (GNumber) data;
		}
		throw new EvaluationException("Cannot process "+data);
	}
